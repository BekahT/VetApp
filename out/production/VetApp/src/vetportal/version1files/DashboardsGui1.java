 ...
 * @author my-pc
 */
public class DashboardsGui1 extends javax.swing.JFrame {

    /**
     * Creates new form DashboardsGui1
     */
    public DashboardsGui1() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        dashboardTabs.addTab("Appointments1", appointmentsTab);
        ...
        dashboardTabs.addTab("Pets1", petsTab);
        ...
        dashboardTabs.addTab("Clients1", clientsTab);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DashboardsGui1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DashboardsGui1().setVisible(true);
            }
        });
    }
