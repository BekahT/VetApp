 ...
 * @author my-pc
 */
public class AddClient1 extends javax.swing.JFrame {

    /**
     * Creates new form AddClient1
     */
    public AddClient1() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddClient1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddClient1().setVisible(true);
            }
        });
    }
